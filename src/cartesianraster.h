...
protected: // attributes
  ...
  /** @todo attention: m_NumProtectLayers has been defined in "patch". If ever "cartesianpatch" will
...
public: // methods
  ...
  /**
   * Build a bounding box in inertial coordinates around the cartesian raster.
   * NOTE: This cartesian raster may be non-aligned to the xyzo-system.
   */
...
//  List* accessCellLink() { return m_CellLink; }
...
inline bool CartesianRaster::checkRange(size_t i, size_t j, size_t k)
{
...
inline void CartesianRaster::ijk(const size_t& l,
                                 size_t& i, size_t& j, size_t& k) const {
  size_t rest;
  i = l / (m_NumJ*m_NumK);
...
inline size_t CartesianRaster::save_index(int i, int j, int k,
                                          bool& error)
{
