...
class AusmPlus : public AusmBase<TReconstruction>
{

public: // methods

  using CompressibleObject::gasCp;
  using CompressibleObject::gasCv;
  using CompressibleObject::gasR;
  using CompressibleObject::gasGamma;
  ...
  void xWallP(CartesianPatch* , size_t, size_t, size_t, real, RealVec<5>&) {}
  void yWallP(CartesianPatch* , size_t, size_t, size_t, real, RealVec<5>&) {}
  void zWallP(CartesianPatch* , size_t, size_t, size_t, real, RealVec<5>&) {}
  void xWallM(CartesianPatch* , size_t, size_t, size_t, real, RealVec<5>&) {}
  void yWallM(CartesianPatch* , size_t, size_t, size_t, real, RealVec<5>&) {}
  void zWallM(CartesianPatch* , size_t, size_t, size_t, real, RealVec<5>&) {}
