...
template <typename TGas>
void CompressibleViscFlux<TGas>::xField(CartesianPatch *patch,
                                        size_t i, size_t j, size_t k,
                                        real x, real y, real z,
                                        real A, real* flux)
{
...
template <typename TGas>
void CompressibleViscFlux<TGas>::yField(CartesianPatch *patch,
                                        size_t i, size_t j, size_t k,
                                        real x, real y, real z,
                                        real A, real* flux)
{
...
template <typename TGas>
void CompressibleViscFlux<TGas>::zField(CartesianPatch *patch,
                                        size_t i, size_t j, size_t k,
                                        real x, real y, real z,
                                        real A, real* flux)
{
