...
class KT : public CompressibleFlux
{
...
public: // methods
  ...
  KT(TReconstruction* reconstruction) { m_Reconstruction = reconstruction; }
...
template <typename TReconstruction, typename TGas>
void KT<TReconstruction, TGas>::xField(CartesianPatch *patch,
                                       size_t i, size_t j, size_t k,
                                       real x, real y, real z,
                                       real A, real* flux)
{
...
template <typename TReconstruction, typename TGas>
void KT<TReconstruction, TGas>::yField(CartesianPatch *patch,
                                       size_t i, size_t j, size_t k,
                                       real x, real y, real z,
                                       real A, real* flux)
{
...
template <typename TReconstruction, typename TGas>
void KT<TReconstruction, TGas>::zField(CartesianPatch *patch,
                                       size_t i, size_t j, size_t k,
                                       real x, real y, real z,
                                       real A, real* flux)
{
