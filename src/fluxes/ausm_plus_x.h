...
real r_l  = TReconstruction::xp(this, r, i, j, k);
real ir_l = 1.0/r_l;
real ru_l = TReconstruction::xp(this, ru, i, j, k);
real rv_l = TReconstruction::xp(this, rv, i, j, k);
real rw_l = TReconstruction::xp(this, rw, i, j, k);
real u_l  = ru_l*ir_l;
real v_l  = rv_l*ir_l;
real w_l  = rw_l*ir_l;
real rE_l = TReconstruction::xp(this, rE, i, j, k);
real T_l  = (rE_l*ir_l - 0.5*(u_l*u_l + v_l*v_l + w_l*w_l))/gasCv();
real p_l  = r_l*gasR()*T_l;
real a_l  = sqrt(gasGamma()*gasR()*T_l);

real r_r  = TReconstruction::xm(this, r, i, j, k);
real ir_r = 1.0/r_r;
real ru_r = TReconstruction::xm(this, ru, i, j, k);
real rv_r = TReconstruction::xm(this, rv, i, j, k);
real rw_r = TReconstruction::xm(this, rw, i, j, k);
real u_r  = ru_r*ir_r;
real v_r  = rv_r*ir_r;
real w_r  = rw_r*ir_r;
real rE_r = TReconstruction::xm(this, rE, i, j, k);
