...
{
  real*  m_Data;            /// variable pointer on patch being
  size_t m_FieldSize;       /// size per variable field in patch data
  size_t m_VariableSize;    /// size per variable in patch data
...
//    m_Data         = other_ls_layer_data.m_Data;
//    m_FieldSize    = other_ls_layer_data.m_FieldSize;
//    m_VariableSize = other_ls_layer_data.m_VariableSize;
...
//    if(m_Data < other_ls_layer_data.m_Data) {
//      return true;
//    }
//    else if (m_Data > other_ls_layer_data.m_Data) {
//      return false;
//    }
//    else {
...
//  real accessInterpolate(size_t i_field, size_t i_variable) {

//    real* var = m_Data + m_FieldSize * i_field + m_VariableSize * i_variable;
//    return (
